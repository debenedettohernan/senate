...
for (var i = 0; i < data.results[0].members.length; i++) {
    var fNames = data.results[0].members[i].first_name
    var mNames = data.results[0].members[i].middle_name;
    var lNames = data.results[0].members[i].last_name;
    ...
    var votes_with_party_pct = data.results[0].members[i].votes_with_party_pct;
}